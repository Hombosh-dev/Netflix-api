...
class MovieStoreDTO extends BaseDTO
{
    /**
     * Create a new MovieStoreDTO instance.
     *
     * @param string $name Movie name
     * @param string $description Movie description
     * @param Kind $kind Movie kind
     * @param Status $status Movie status
     ...
     * @param bool $isPublished Whether the movie is published
    ...
    public static function fromRequest(Request $request): static
    {
        ...
        $related = self::processRelatedMovies($request->input('related', []));
